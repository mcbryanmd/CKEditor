...
$.widget("ui.selectmenu", {
	...
	_create: function() {
		...
		this.newelement = $('<a class="' + this.widgetBaseClass + ' ui-widget ui-state-default" id="' + this.ids[0] + '" role="button" href="#" tabindex="0" aria-haspopup="true" aria-owns="' + this.ids[1] + '"></a>')
	...
	_init: function() {
		...
		this.list
			.toggleClass(self.widgetBaseClass + "-menu-dropdown", isDropDown)
			.toggleClass(self.widgetBaseClass + "-menu-popup", !isDropDown)
			.addClass("ui-corner-all")
			// round corners for all menu items
			.find("li")
			.addClass("ui-corner-all");
			/*
	...
	open: function(event) {
		...
		if ( disabledStatus != 'true' ) {
			...
			/*if ( this.options.style == "dropdown" ) {
				this.newelement.removeClass('ui-corner-left').addClass('ui-corner-tl');
			}*/
			this._refreshPosition();
	...
	close: function(event, retainFocus) {
		if ( this.newelement.is('.ui-state-active') ) {
			...
			/*if ( this.options.style == "dropdown" ) {
				this.newelement.removeClass('ui-corner-tl').addClass('ui-corner-left');
			}*/
			if ( retainFocus ) {
